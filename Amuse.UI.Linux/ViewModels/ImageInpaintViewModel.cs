...
{
    public partial class ImageInpaintViewModel : ObservableObject
    {
        ...
        [ObservableProperty] private string _selectedModel  = "runwayml/stable-diffusion-inpainting";
        ...
        [ObservableProperty] private Bitmap _maskImagePreview;
        ...
        {
            new("SD Inpainting (default)", "runwayml/stable-diffusion-inpainting", false, 512),
            new("Custom (enter model ID below)", "", false, 512),
        };

        public ImageInpaintViewModel()
        {
            _ = CheckDepsAsync();
        }
        ...
        private bool CanGenerate() =>
            ...
            !string.IsNullOrWhiteSpace(MaskImagePath);
        ...
        private void SaveImage()
        {
            ...
            var dest = Path.Combine(dir, $"inpaint_{DateTime.Now:yyyyMMdd_HHmmss}.png");
        ...
        public void SetMaskImage(string path)
        {
            MaskImagePath = path;
            if (File.Exists(path))
                try { MaskImagePreview = new Bitmap(path); } catch { MaskImagePreview = null; }
        }
