...
{
    public partial class PaintToImageViewModel : ObservableObject
    {
        ...
        [ObservableProperty] private float  _strength       = 0.9f;
        ...
        {
            new("SD 1.5 (recommended)", "runwayml/stable-diffusion-v1-5", false, 512),
        ...
        private void SaveImage()
        {
            ...
            var dest = Path.Combine(dir, $"paint2img_{DateTime.Now:yyyyMMdd_HHmmss}.png");
