...
namespace Amuse.UI.Linux.ViewModels
{
    public partial class ImageEditViewModel : ObservableObject
    {
        ...
        [ObservableProperty] private string _selectedModel    = "timbrooks/instruct-pix2pix";
        [ObservableProperty] private int    _steps            = 20;
        [ObservableProperty] private float  _guidanceScale    = 7.5f;
        [ObservableProperty] private float  _imageGuidanceScale = 1.5f;
        ...
        {
            new("InstructPix2Pix (default)", "timbrooks/instruct-pix2pix", false, 512),
        ...
        private void SaveImage()
        {
            ...
            var dest = Path.Combine(dir, $"edit_{DateTime.Now:yyyyMMdd_HHmmss}.png");
