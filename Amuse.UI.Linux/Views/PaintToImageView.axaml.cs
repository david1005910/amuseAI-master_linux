...
{
    public partial class PaintToImageView : UserControl
    {
        public PaintToImageView()
        {
            DataContext = new PaintToImageViewModel();
            InitializeComponent();
        }
        ...
        private async void OnBrowseInputImageClick(object sender, RoutedEventArgs e)
        {
            ...
            {
                Title = "Select Sketch / Paint Image",
                AllowMultiple = false,
                FileTypeFilter = new[]
                {
            ...
            if (files.Count > 0 && DataContext is PaintToImageViewModel vm)
        ...
        private async void OnPastePromptClick(object sender, RoutedEventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(text) && DataContext is PaintToImageViewModel vm)
                vm.Prompt = text;
        }
    }
}
